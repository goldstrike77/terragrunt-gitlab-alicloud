...
module "alicloud_log_project" {
  source             = "git::https://gitea.home.local/suzhetao/terraform-module-alicloud.git//sls/log-project?ref=1.x"
  tags               = var.tags
  alicloud_resources = var.alicloud_resources
...
module "alicloud_oss_bucket" {
  source             = "git::https://gitea.home.local/suzhetao/terraform-module-alicloud.git//oss/oss-bucket?ref=1.x"
  tags               = var.tags
  alicloud_resources = var.alicloud_resources
  depends_on         = [module.alicloud_resource_manager_resource_group]
}
...
module "alicloud_actiontrail_trail" {
  source             = "git::https://gitea.home.local/suzhetao/terraform-module-alicloud.git//actiontrail/actiontrail-trail?ref=1.x"
  alicloud_resources = var.alicloud_resources
